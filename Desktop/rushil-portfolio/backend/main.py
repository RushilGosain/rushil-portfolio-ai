...
2. Expert-Booking Platform
   ...
   - Developed RESTful APIs with Express.js for expert management and booking operations, including duplicate booking prevention and admin CRU functionality.
