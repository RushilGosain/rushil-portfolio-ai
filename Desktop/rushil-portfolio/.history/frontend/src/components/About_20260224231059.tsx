        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'start' }}>
          ...
          <div>
            ...
            <p style={{ color: 'var(--silver)', lineHeight: 1.8, fontSize: '1rem', marginTop: '1rem' }}>
              With hands-on skills in <span style={{ color: '#00F5FF' }}>frontend development</span>, <span style={{ color: '#00F5FF' }}>programming</span>, and <span style={{ color: '#00F5FF' }}>problem-solving</span> using <span style={{ color: '#00F5FF' }}>data structures & algorithms</span>.
            </p>
          </div>
