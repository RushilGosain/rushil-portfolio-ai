...
const projects = [
  ...
  {
    title: ',
    desc: 'Personal tech portfolio with interactive UI effects including particle constellations, comet cursor, aurora waves, and detailed coding demonstrations.',
    tags: ['HTML5', 'CSS3', 'Canvas API'],
