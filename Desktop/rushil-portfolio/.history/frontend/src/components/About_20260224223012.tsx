...
const About: React.FC = () => {
  ...
  const fullText = "Hi! I'm a B.Tech CS student passionate about coding, building digital experiences, and solving problems efficiently. Football keeps me disciplined, focused, and driven off screen.";
