...
const About: React.FC = () => {
  ...
  const fullText = "I'm Rushil — a B.Tech CS student who turns ideas into interactive digital experiences. I live at the intersection of clean code and creative design, with a strong grip on frontend development, DSA, and AI-powered tools.";
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'start' }}>
          ...
          <div>
            ...
            <p style={{ color: 'var(--silver)', lineHeight: 1.8, fontSize: '1rem' }}>
               Whether it's building a mental health platform or a quiz app, I bring both technical precision and creative energy to every project. 
            </p>
            <p style={{ color: 'var(--silver)', lineHeight: 1.8, fontSize: '1rem', marginTop: '1rem' }}>
              With hands-on skills in <span style={{ color: '#00F5FF' }}>Full Stack development</span>, <span style={{ color: '#00F5FF' }}>programming</span>, and <span style={{ color: '#00F5FF' }}>problem-solving</span> using <span style={{ color: '#00F5FF' }}>data structures & algorithms</span>.
            </p>
          </div>
