...
const About: React.FC = () => {
  ...
  const fullText = "I'm Rushil — a B.Tech CS student who turns ideas into interactive digital experiences. I live at the intersection of clean code and creative design, with a strong grip on  development, DSA, and AI-powered tools.";
